...
class EstadoCuentaController extends Controller
{
    ...
    public function obtenerIngresos($concentrado,$idPeriodo=null,$idFchInicio=null,$idFechaFin=null,$idCajero=null,
                                    $idCarrera=null,$idTipoPago){
                     $resultados = DB::table('edocta as cta')
                                                        ->select(
                                                            'cta.uid',
                                                            'pers.nombre',
                                                            'pers.primerApellido',
                                                            ...
                                                            DB::raw("CONCAT(cj.nombre, ' ', cj.primerApellido, ' ', cj.segundoApellido) as nombreCajero"),
                        ...
                        ->leftJoin('persona as cj', 'cj.uid', '=', 'cta.uidcajero')
                        ->where('cta.FechaPago', '>', DB::raw("STR_TO_DATE('01/02/2025', '%d/%m/%Y')"))
...
/**
    ...
    public function generateReportIngresos($data, $columnWidths, $keys, $title, $headers, $orientation, $size, $nameReport)
    {
        // Rutas de las imágenes para el encabezado y pie
        $imagePathEnc = public_path('images/encPag.png');
        $imagePathPie = public_path('images/piePag.png');
